...
you can use this powershell command to register your subscriptionRegister-AzProviderFeature -FeatureName "CreateOptionClone" -ProviderNamespace "Microsoft.Compute"
