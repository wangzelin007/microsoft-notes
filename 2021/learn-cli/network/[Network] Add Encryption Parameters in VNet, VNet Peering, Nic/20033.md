...
update
- [] az network vnet peering update --name MyVnet1ToMyVnet21 --resource-group zelin62 --enable-encryption true --encryption-enforcement-policy allowUnencrypted
- [] az network vnet peering update --name MyVnet1ToMyVnet21 --resource-group zelin62 --enable-encryption true --encryption-enforcement-policy dropUnencrypted
- [] az network vnet peering update --name MyVnet1ToMyVnet21 --resource-group zelin62 --enable-encryption false --encryption-enforcement-policy allowUnencrypted
- [] az network vnet peering update --name MyVnet1ToMyVnet21 --resource-group zelin62 --enable-encryption false --encryption-enforcement-policy dropUnencrypted
- [] az network vnet peering update --name MyVnet1ToMyVnet21 --resource-group zelin62 --enable-encryption true
- [] az network vnet peering update --name MyVnet1ToMyVnet21 --resource-group zelin62 --enable-encryption false
- [] az network vnet peering update --name MyVnet1ToMyVnet21 --resource-group zelin62 --enable-encryption allowUnencrypted
- [] az network vnet peering update --name MyVnet1ToMyVnet21 --resource-group zelin62 --enable-encryption dropUnencrypted
